...
class AdoptableState extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        isToggleOn: true,
      ...
      fetch('http://localhost:8080/test/adoptablestate')
    ...
    render() {
      ...
      return (
        <div>
          <h> Which state has the most adoptable dogs?</h>
